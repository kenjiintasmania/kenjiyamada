...
{ no:6, title:"並べかえ（X・Yコースのどちらかを選んで答えなさい）", lead:"［　］内の語を正しく並べかえ、英文を完成させましょう。文の最初にくる語も小文字で示しています。",
  courses:[
    ...
    { name:"Yコース", items:[
      ...
      { type:"wordorder", label:"(2)", pt:3, stem:'A: I didn\'t run ［ '+E("because / it / was / very")+' ］ hot this morning.　B: I see.',
        words:["because","it","was","very"], answer:"I didn't run because it was very hot this morning.",
        display:"I didn't run because it was very hot this morning." },
      { type:"wordorder", label:"(3)", pt:3, stem:'A: I went to ［ '+E("to / my / watch / stadium")+' ］ team last week.　B: That\'s nice.',
        words:["to","my","watch","stadium"], answer:"I went to the stadium to watch my team last week.",
        display:"I went to the stadium to watch my team last week." },
