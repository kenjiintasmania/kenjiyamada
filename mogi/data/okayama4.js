...
{ no:1, title:"リスニングテスト", lead:"放送文を読んで、内容に合うものを選びましょう（実際の試験では音声が流れます）。", groups:[
  ...
  { intro:"問題D　あなたとクラスメイトのアカリ(Akari)が、果物農園の体験コースについての説明を聞いて話しています。放送を聞いて(1)(2)に答えなさい。英文は2回読まれます。",
    script:
      ...
      '<span class="sp"><span class="who">Akari:</span> I really love grapes. Which course will you choose?</span>',
    items:[
    ...
    { type:"fill", label:"(2)", pt:3, stem:"アカリの発言に対するあなたの答えを完成させなさい。<br>"+E("I really love grapes. So I will choose （　　）.")+"（英語2語）",
      answers:["course b"], hint:"英語2語" } ] }
]},

/* ===== 大問2 ちらし＋対話 ===== */
{ no:2, title:"中学生のスバル(Subaru)とコハル(Koharu)が、ミドリ町の「桃狩り体験」のちらしを見ながら話しています。(1)〜(5)に答えなさい。", groups:[
  { flyer:
    ...
    passage:
    '<span class="sp"><span class="who">Subaru:</span> Look, Koharu. Did you know about this event?</span>'+
    '<span class="sp"><span class="who">Koharu:</span> Yes. Midori Farm grows the （　あ　） sweet peaches in our town.</span>'+
    '<span class="sp"><span class="who">Subaru:</span> Sounds nice. I want to join, but I\'m not （　い　） that I can pick good ones.</span>'+
    '<span class="sp"><span class="who">Koharu:</span> You don\'t need to worry about that. The farm people will help us.</span>'+
    '<span class="sp"><span class="who">Subaru:</span> Good. Then let\'s go together with my little brother. He is seven years old.</span>'+
    '<span class="sp"><span class="who">Koharu:</span> Your brother is not a junior high student, so he doesn\'t need a ticket. Children under twelve can join for free.</span>'+
    '<span class="sp"><span class="who">Subaru:</span> Oh, that\'s good news. So we need two student tickets. The peaches at this farm are the <u>(う) sweet</u> I have ever eaten.</span>'+
    '<span class="sp"><span class="who">Koharu:</span> I agree. Let\'s also try one cup of peach juice each after picking.</span>'+
    '<span class="sp"><span class="who">Subaru:</span> Nice. The free bus is helpful, too. We can meet at the station before it leaves.</span>'+
    '<span class="sp"><span class="who">Koharu:</span> The event is two days from now. I\'m （　い　） we will have a great time.</span>',
    ...
    { type:"mcq", label:"(4)", pt:3, stem:"スバルとコハルの2人が当日に支払う合計金額として最も適当なのは、ア〜エのどれですか。（弟は無料）",
    ...
    { type:"mcq", label:"(5)", pt:4, stem:"ちらしや会話から読み取れる内容として最も適当なのは、ア〜エのどれですか。",
      choices:[ E("People can pick five peaches with one ticket."),
                E("Subaru's little brother needs a student ticket."),
                E("The free bus leaves from Midori Station at nine."),
                E("Subaru and Koharu are talking on August 9.") ], answer:0 } ]}
]},

/* ===== 大問3 日記の英作文（並べかえ2問） ===== */
{ no:3, title:"リコ(Riko)には、マヤ(Maya)という友達がいます。次は、ある日のリコの日記の一部と、その日のできごとを表したイラストです。日記とイラストの内容に合うように、(1)(2)の語を正しく並べかえて、日記を完成させなさい。", groups:[
  { sceneNote:"イラスト：マヤの家の庭に大きな桃の木があり、二人で木に実った桃を見上げている。夜には二人でジャムを作っている。",
    passage:
    'August 9<br><br>'+
    'This morning, Maya took me to her garden. There was a big tree there, and it was full of peaches. '+
    'I was surprised and said, "<u>(1)</u>!" Maya smiled and said, "Yes. My grandfather planted it ten years ago." '+
...
/* ===== 大問4 話し合い＋感想 ===== */
{ no:4, title:"リー(Mr. Lee)先生と中学校の英語部の Asuka(あすか)、Itsuki(いつき)、Momo(もも)が、それぞれの地域でとれる果物について話し合いをしています。次の英文は、話し合いと、それを聞いて Sena が書いた感想です。(1)〜(5)に答えなさい。", groups:[
  { passage:
    '<span class="sp"><span class="who">Mr. Lee:</span> Good afternoon, everyone. Today, let\'s talk about local fruit in your areas. Asuka, can you tell us first?</span>'+
    '<span class="sp"><span class="who">Asuka:</span> OK. In my city in America, many farmers grow apples. In autumn, we visit an apple farm and pick apples with our family.</span>'+
    '<span class="sp"><span class="who">Itsuki:</span> I\'m from Spain. In my town, people grow a lot of oranges. When I was a child, I often ate fresh oranges from my grandmother\'s garden.</span>'+
    '<span class="sp"><span class="who">Momo:</span> That\'s nice. In Hikari Town, we are famous for peaches. Every summer, many people come to pick sweet peaches at our farms.</span>'+
    ...
    '<span class="sp"><span class="who">Momo:</span> My cousin lives in a big city, and he sometimes buys fruit only at a supermarket.</span>'+
    '<span class="sp"><span class="who">Itsuki:</span> Really? （　お　）</span>'+
    '<span class="sp"><span class="who">Momo:</span> He buys apples and oranges, but he has never picked them at a farm.</span>'+
    '<span class="sp"><span class="who">Asuka:</span> <u>(か) I became interested in Japanese peaches</u> when I read a book about Hikari Town. In the book, children picked peaches and made juice. So I tried a peach cake in America.</span>'+
    '<span class="sp"><span class="who">Itsuki:</span> Sounds great. I want to make orange juice in Spain, but I miss the peaches here.</span>'+
    '<span class="sp"><span class="who">Momo:</span> Then, when you visit Hikari Town, let\'s pick peaches together.</span>'+
  ...
  { passage:'<b>Sena の感想</b><br>Fruit in different areas is interesting. Like Momo, I am proud of the peaches in my town. '+
            'I want to （　き　） like Asuka\'s family. I have never done that, so it sounds like fun.', passageEn:true,
    items:[
    ...
    { type:"mcq", label:"(4)", pt:3, stem:"話し合いの内容と合っているのは、ア〜エのどれですか。",
      choices:[ E("Asuka picks apples with her family in autumn."),
                E("Itsuki grows peaches in Spain now."),
                E("Momo's cousin often picks fruit at a farm."),
                E("Asuka tried a peach cake in Japan.") ], answer:0 },
...
/* ===== 大問5 長文スピーチ（読解） ===== */
{ no:5, title:"次の英文は、ヒロ(Hiro)が地元のフルーツカフェについて発表したスピーチです。(1)〜(6)に答えなさい。", groups:[
  { passage:
    '<b>①</b> Hello, everyone. I\'m Hiro. Today I want to talk about a small café in Wakaba Town. '+
    ...
    { type:"fill", label:"(4)え", pt:4, stem:"次の文の（え）に入れるのに最も適当な英語2語を、第2段落中から抜き出して書きなさい。<br>"+E("At first, Hiro's aunt （　え　） because only a few people came."),
    ...
    { type:"mcqMulti", label:"(6)", pt:7, stem:"本文の内容と合っているものを、ア〜オから二つ選びなさい。",
      choices:[ E("Hiro's aunt opened her café near Wakaba Station last spring."),
                E("Many people came to the café from the first day."),
                E("Hiro told his aunt to close the café."),
                E("Children made fruit juice with Hiro's aunt at the event."),
                E("Hiro thinks people should give up easily.") ], answer:[0,3] } ]}
]}
