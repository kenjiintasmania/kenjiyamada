...
var STUDENT_SPREADSHEET_ID = "1x3jpH6zynyl-9Pw14XxvoNpza0N17vsLhKgky5dXNJs";
...
var GAS_VERSION = "trial-jigaku-12";   // 実証版であることが /admin 上部で分かるようにする   // ★"jigaku" を含むと自学ログ対応。アプリ側が送信可否の判定に使う
