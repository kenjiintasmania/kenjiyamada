...
const PAGES = [
  ...
  ['jigaku/honbun.html', '自学（本文）',
   ...
   '採点→送信で「自学ログ」に1行増える'],
  ['mastery/index.html', '2000語 到達度テスト',
   '100語×20セット。先生が受付を開けている間だけ。時間制限なし・続きのセットから再開',
   '受付前はロック表示／1セット終えると 実証シートの「到達度テスト」に1行増える'],
  ['mastery/gram.html', '全文法 到達度テスト',
   '31項目×5文。7つの箱にえらんで入れる。解説はたたんであり、開きたい人だけ開く',
   '受付前はロック表示／1項目終えると 実証シートの「到達度テスト」に1行増える'],
